...
export const DestinationShowcase = () => {
  ...
  // Function to get appropriate icon based on highlight text
            ...
            >
              ...
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100/50 backdrop-blur-sm">
                ...
                <div className="relative h-80 overflow-hidden cursor-pointer group/image">
                  <div className={`absolute inset-0 bg-gradient-to-br ${destination.color} opacity-20 group-hover:opacity-10 transition-opacity duration-500`} />
                  <img
                  ...
                  {/* Overlay Gradient */}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent opacity-80 group-hover:opacity-50 transition-opacity duration-500" />
                  ...
                  <motion.div
                    ...
                    className="absolute top-4 right-4 bg-white/95 backdrop-blur-md px-3 py-2 rounded-2xl shadow-lg flex items-center gap-1.5"
                  >
                  ...
                  <motion.div
                    ...
                    className="absolute top-4 left-4 bg-black/70 backdrop-blur-md text-white px-3 py-2 rounded-2xl flex items-center gap-1.5"
                  >
                    <Calendar size={14} />
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                    className="absolute inset-0 bg-black/50 backdrop-blur-md flex items-center justify-center opacity-0 group-hover/image:opacity-100 transition-opacity duration-300 p-4"
                  >
                    <motion.div
